          ...
          <button
            ...
            className={`${
              answer === i && answer === question.correctOption
                ...
                : "unanswered"
            } my-4 md:py-4 py-2 hover:md:translate-x-8 hover:translate-x-2 hover:bg-slate-400 transform duration-200 transition-all  text-white text-left px-5 rounded-2xl`}
            key={i}
            onClick={() =>
              dispatch({
                type: "answered",
